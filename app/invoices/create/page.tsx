...
export default async function Page({ searchParams }: { searchParams?: { providerId?: string } }) {
  ...
  const providerProducts = providerId ? await fetchProviderProducts(providerId) : null;
